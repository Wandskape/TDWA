...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        using (IRepository repository = Repository.Create("D:\\6sem\\TDWA\\2\\ASPA\\Test_DAL004\\Celebrities"))
        {
            ...
            int? testupd3 = repository.addCelebrity(new Celebrity(0, "TestUpd2", "TestUpd2", "Photo/TestUpd2.jpg"));
            ...
            if (testupd1 != null)
                if ((repository.updCelebrityById((int)testupd1, new Celebrity(0, "Updated1", "Updated1", "Photo/Updated1.jpg"))).HasValue) 
                    Console.WriteLine($" update {testupd1} "); 
                else 
                    Console.WriteLine($"update {testupd1} error");

            if (testupd2 != null)
                if ((repository.updCelebrityById((int)testupd2, new Celebrity(0, "Updated2", "Updated 2", "Photo/Updated2.jpg"))).HasValue) 
                    Console.WriteLine($" update {testupd2} "); 
                else 
                    Console.WriteLine($"update {testupd2} error");

            if (testupd3 != null)
                if ((repository.updCelebrityById((int)testupd3, new Celebrity(0, "Updated2", "Updated 2", "Photo/Updated2.jpg"))).HasValue)
                    Console.WriteLine($" update {testupd3} ");
                else
                    Console.WriteLine($"update {testupd2} error");

            if ((repository.updCelebrityById(1000, new Celebrity(0, "Updated1000", "Updated1000", "Photo/Updated1000.jpg"))).HasValue) 
